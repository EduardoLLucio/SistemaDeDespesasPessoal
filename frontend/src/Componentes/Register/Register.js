...
const Register = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    try{
    // DEBUG: mostrar senha e tamanho em bytes antes de enviar (remover depois)
    console.log("Senha enviada (repr):", senha);
    console.log("Senha length (chars):", senha.length);
    console.log("Senha length (bytes UTF-8):", new TextEncoder().encode(senha).length);
